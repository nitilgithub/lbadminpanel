...
<script>
    ...
    function getGraphData(year) {
        ...
        $.ajax({
            ...
            url: 'https://www.laundrybucket.co.in/lb-admin/webservice_orderfromnggn.php?val='+year,
            beforeSend: function () {
                $('#loading-wrp').show();
            },
            success: function (data) {
                ...
                var bar = new Morris.Bar({
                    ...
                    resize: true,
                    data: data,
                    barColors: ['#00a65a', '#f56954','#5F9EA0','#f49230','#4a809b'],
                    xkey: 'y',
                    ykeys: ['a','b','c','d','e'],
                    labels: ['Other','Noida','Greater Noida','Ghaziabad','East Delhi'],
                    hideHover: 'auto'
                });
