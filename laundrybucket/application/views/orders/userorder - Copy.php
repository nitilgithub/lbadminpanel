    ...
    <div class="span12">
      <div class="widget-box">
        <div class="widget-title"> <span class="icon"> <i class="icon-align-justify"></i> </span>
          <h5><?= $userInfo->UserFirstName." ".$userInfo->UserLastName ?>'s Place Order(New)/Check Status of Existing Order</h5>
        </div>
			 ...
			 ?>
          	...
          	<?php
				...
				elseif ($type == 'date')
                {
                    $datePicker = true;
                ?>
                    <input type="text" name="<?= $cname; ?>" id="<?= $control['id']; ?>" value="<?= !empty($values) ? $values->$cname : ''; ?>" class="datepicker span11">
                <?php
                }
				else {
          	?>	
